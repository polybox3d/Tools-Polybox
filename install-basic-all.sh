...
echo "*Lib: "
sudo apt-get -y install devscripts debhelper dh-kpatches findutils build-essential
sudo apt-get -y install libreadline-dev xsltproc groff python-lxml libglu1-mesa-dev libgl1-mesa-dev libglib2.0-dev libgtk2.0-dev
sudo apt-get -y install libeigen3-dev build-essential libgtk2.0-dev libjpeg-dev libtiff4-dev libjasper-dev libopenexr-dev cmake python-dev python-numpy python-tk
sudo apt-get -y install libtbb-dev yasm libfaac-dev libopencore-amrnb-dev libopencore-amrwb-dev libtheora-dev libvorbis-dev libxvidcore-dev libx264-dev sphinx-common
...
sudo apt-get -y install qtmobility-dev
sudo apt-get -y install qt5-default qttools5-dev-tools qtmultimedia5-dev libqt5opengl5-dev
#Qt4.x
